...
import fr.uha.perrier.attraction.databinding.FragmentPersonBinding
...
class PersonFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener(ATTRACTIONCOLLECTION, this, FragmentResultListener {
            ...
            personViewModel!!.addAttractionCollection(attractionCollectionId)
        })
    }
    ...
    override fun onCreateView(
        ...
        _binding = DataBindingUtil.inflate(inflater, R.layout.fragment_person, container, false)
        binding.lifecycleOwner = viewLifecycleOwner

        binding.setAddAttractionCollection {
            var action = PersonFragmentDirections.actionNavigationPersonToAttractionPickerFragment(ATTRACTIONCOLLECTION)
        ...
        personViewModel!!.attractionsCollection.observe(viewLifecycleOwner) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val id = PersonFragmentArgs.fromBundle(requireArguments()).id
        if (id == 0L) {
    ...
    private fun onRemove(attraction: Attraction) {
        personViewModel!!.removeAttraction(attraction.aid)
    }
